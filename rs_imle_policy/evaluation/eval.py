...
target_mask, target_image = load_image_as_mask(target_mask_path, crop_box=crop_box, mask_red=True)
predicted_mask, predicted_image = load_image_as_mask(predicted_mask_path, crop_box=crop_box, mask_red=True)
